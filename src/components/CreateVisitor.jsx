          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Complete the form below to check in a visitor</p>
              </div>
            </div>
              ...
              <div className="lg:col-span-2 space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    {errors.employeeToMeet && <p className="mt-1 text-xs text-red-500">{errors.employeeToMeet}</p>}
                  </div>
                </div>
...
<div>
  ...
  <input
    ...
    className={`w-full px-4 py-3.5 border ${
      errors.visitDateTime ? 'border-red-500' : 'border-gray-300'
    } rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition bg-gray-50 focus:bg-white`}
  />

  {errors.visitDateTime && (
    <p className="mt-1 text-xs text-red-500">{errors.visitDateTime}</p>
  )}
</div>
